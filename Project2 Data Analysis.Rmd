...
ggpairs(df) %>% keep(is.numeric)
ggcorr(df)

```


```{r EDA - big plots, eval=FALSE}


#Saved as ./figures/pairs.png
...
```{r boruta - random forest package - can go to EDA, cache=TRUE}
