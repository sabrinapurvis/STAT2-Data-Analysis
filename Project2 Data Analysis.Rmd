...
# Smaller model:
smallerLog <- glm(y~job+contact+month+day_of_week+campaign+pdays+poutcome+emp.var.rate+cons.price.idx+cons.conf.idx+nr.employed, data=train, family="binomial")
summary(smallerLog)
