...
```{r EDA_VariableImportance, out.height=500, out.width=500, fig.align="center", fig.cap='Variable Importance Plot', echo=FALSE}

knitr::include_graphics('./figures/variableImportance.png')
