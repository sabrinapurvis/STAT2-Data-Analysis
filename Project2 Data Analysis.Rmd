...
model.main<-glm(y~job+marital+education+contact+month+campaign+poutcome+emp.var.rate+cons.conf.idx, traindata, 
...
fit1.pred.train <- predict(model.main, newdata = traindata) 
